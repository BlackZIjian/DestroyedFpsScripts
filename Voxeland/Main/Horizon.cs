...
namespace Voxeland5
{
	...
	public class Horizon : MonoBehaviour
	{
		...
		//	horizon.OnEnable();
			...
			horizon.meshFilter.sharedMesh.bounds = new Bounds(horizon.meshFilter.sharedMesh.bounds.center, new Vector3(horizon.meshFilter.sharedMesh.bounds.extents.x, 10000, horizon.meshFilter.sharedMesh.bounds.extents.z) );
