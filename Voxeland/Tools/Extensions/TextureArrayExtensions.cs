...
namespace Voxeland5
{
	public static class TextureArrayTools 
	{
		...
		{
			Texture2D tex = new Texture2D(srcArr.width, srcArr.height, srcArr.format, mipmap:true, linear:srcArr.IsLinear());
		...
		/// Bulk textures copy from index to index
		{
			...
			Texture2D tmpTex = new Texture2D(dstArr.width, dstArr.height, dstArr.format, mipmap:true, linear:srcArr.IsLinear());
			for (int i=0; i<length; i++)
			{
		...
		{
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth+1, texArr.format, mipmap:true, linear:texArr.IsLinear());
		...
		static public Texture2DArray Insert (Texture2DArray texArr, int pos, Texture2D tex)
		{
			...
			{ 
				texArr = new Texture2DArray(tex.width, tex.height, 1, texArr.format, mipmap:true, linear:linear);
			...
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth+1, texArr.format, mipmap:true, linear:linear);
			newArr.name = texArr.name;
		...
		static public Texture2DArray InsertRange (Texture2DArray texArr, int pos, Texture2DArray addArr)
		{
			...
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth+addArr.depth, texArr.format, mipmap:true, linear:texArr.IsLinear());
			newArr.name = texArr.name;
		...
		{	
			Texture2D temp = new Texture2D(texArr.width, texArr.height, texArr.format, mipmap:true, linear:texArr.IsLinear());
		...
		static public Texture2DArray ChangeCount (Texture2DArray texArr, int newSize)
		{
			...
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, newSize, texArr.format, mipmap:true, linear:texArr.IsLinear());
			newArr.name = texArr.name;
		...
		{
			Texture2DArray newArr = new Texture2DArray(newWidth, newHeight, texArr.depth, texArr.format, mipmap:true, linear:texArr.IsLinear());
			newArr.name = texArr.name;
		...
		{
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth, format, mipmap:true, linear:texArr.IsLinear());
			newArr.name = texArr.name;
		...
		{
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth, texArr.format, mipmap:true, linear:linear);
			newArr.name = texArr.name;
		...
		{
			Texture2DArray newArr = new Texture2DArray(texArr.width, texArr.height, texArr.depth, texArr.format, mipmap:true, linear:texArr.IsLinear());
			for (int i=0; i<texArr.depth; i++)
			{
				CopyTexture(texArr,i, newArr,i);
			}
